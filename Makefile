...
OFILES = main.o text.o mylib.o font.o screens/title.o screens/win.o screens/lost.o X.o stage.o megaman.o stagemusic.o 
# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h screen.h screens/startgame.h screens/win.h screens/lost.h X.h stage.h megaman.h stagemusic.h
################################################################################
